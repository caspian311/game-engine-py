...
def calculate_title_position(middle_of_window_width, middle_of_window_height):
    return (_calculate_title_position_width(middle_of_window_width),
            _calculate_title_height(middle_of_window_height))

def _calculate_title_position_width(middle_of_window_width):
...
def _calculate_title_height(middle_of_window_height):
    title_height = len(title_screen_content)
